...
tri = shapes.InfiniteTriangle(base_size=TRIANGLE_SIZE, num_triangles=20, 
        generators=dict(
            color_generator=shapes.default_color_generator(color=(200,0,0)),
            zoom_generator=shapes.default_zoom_generator(),
            angular_speed_generator=shapes.sin_wave_angular_speed_generator(mul=2, speed=1, baseline=0.5)
            )
        )
